...
### 👦Sobre mim :seedling: :  
Olá! Me chamo Kleber Gonçalves e sou apaixonado por tecnologia, dados e resolver problemas com código.  
🎓 Em formação Bacharelado em Ciêcia de dados, também sou autodidata com dezenas de cursos, projetos e artigos publicados.  
🧠 Atuo como Analista de Segurança da Informação.  
🛠️ Tenho experiência em Python.  
